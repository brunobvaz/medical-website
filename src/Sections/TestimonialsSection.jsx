  ...
  return (
    <Section className="testimonials-section" id="testemunhos" aria-labelledby="testimonials-title">
      ...
      <SectionContainer className="testimonials-section__inner">
        <div className="testimonials-section__portrait">
          <img src={activeTestimonial.image} alt={`${activeTestimonial.name}, ${activeTestimonial.treatment}`} />
        </div>

        <article className="testimonials-section__testimonial" aria-live="polite">
